...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(RectifyConfig::AbstractParamDescriptionConstPtr(new RectifyConfig::ParamDescription<int>("interpolation", "int", 0, "Interpolation algorithm between source image pixels", "{'enum': [{'name': 'NN', 'type': 'int', 'value': 0, 'srcline': 9, 'srcfile': '/home/dl/vision_ws/src/fs-racing-yolo/src/camera/image_pipeline/image_proc/cfg/Rectify.cfg', 'description': 'Nearest neighbor', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Linear', 'type': 'int', 'value': 1, 'srcline': 10, 'srcfile': '/home/dl/vision_ws/src/fs-racing-yolo/src/camera/image_pipeline/image_proc/cfg/Rectify.cfg', 'description': 'Linear', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Cubic', 'type': 'int', 'value': 2, 'srcline': 11, 'srcfile': '/home/dl/vision_ws/src/fs-racing-yolo/src/camera/image_pipeline/image_proc/cfg/Rectify.cfg', 'description': 'Cubic', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Lanczos4', 'type': 'int', 'value': 4, 'srcline': 12, 'srcfile': '/home/dl/vision_ws/src/fs-racing-yolo/src/camera/image_pipeline/image_proc/cfg/Rectify.cfg', 'description': 'Lanczos4', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'interpolation type'}", &RectifyConfig::interpolation)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/home/dl/vision_ws/src/fs-racing-yolo/src/camera/image_pipeline/image_proc/cfg/Rectify.cfg"
      const int Rectify_NN = 0;
//#line 10 "/home/dl/vision_ws/src/fs-racing-yolo/src/camera/image_pipeline/image_proc/cfg/Rectify.cfg"
      const int Rectify_Linear = 1;
//#line 11 "/home/dl/vision_ws/src/fs-racing-yolo/src/camera/image_pipeline/image_proc/cfg/Rectify.cfg"
      const int Rectify_Cubic = 2;
//#line 12 "/home/dl/vision_ws/src/fs-racing-yolo/src/camera/image_pipeline/image_proc/cfg/Rectify.cfg"
