...
echo_and_run cd "/home/dl/Desktop/FS-Racing-YOLO/src/image_pipeline/camera_calibration"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/dl/Desktop/FS-Racing-YOLO/src/image_pipeline/camera_calibration/setup.py" \
    egg_info --egg-base /home/dl/Desktop/FS-Racing-YOLO/build/image_pipeline/camera_calibration \
    build --build-base "/home/dl/Desktop/FS-Racing-YOLO/build/image_pipeline/camera_calibration" \
    install \
    --root="${DESTDIR-/}" \
