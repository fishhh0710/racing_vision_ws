...
marker_array_pub_l = rospy.Publisher("/yolo/objects/marker_array_left", MarkerArray, queue_size=10)
...
def yolo_proc(proimg, lr):
    ...
    marker_array_pub_l.publish(delete_marker_array)
    ...
    for box in result[0].boxes:
        ...
        marker.ns = "projected_points_left"
        marker.id = i
    ...
    marker_array_pub_l.publish(marker_array)
...
def process():
    rospy.init_node("dual_yolo_node_left")
